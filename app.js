...
mongoose.connect("mongodb+srv://admin-rishabh:test@cluster0.cxczm1m.mongodb.net/blogDB", {useNewUrlParser: true});
...
app.post("/compose",function(req,res){
  const postName = req.body.composeTitle;
  const postBody = req.body.composePost;
